/** *************************************************************
 * Please refer to the Repo Options section in documentation   *
 ****************************************************************/
...
export const social = [
  {
    name: 'Twitter',
    url: 'https://www.twitter.com/peterkuria2000',
    Icon: IoLogoTwitter,
  },
  {
    name: 'Instagram',
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/peterkuria2000/',
    Icon: IoLogoLinkedin,
  },
]
...
export const config = {
  ...
  convertKit: {
    tipUrl: 'https://github.com/peterkuria1/peterkuria1',
  },
  contactForm: {
...
export const siteMetaData = {
  ...
  authorName: 'Peter Kuria',
  siteName: 'Peter Kuria',
  defaultTitle: 'Peter Kuria Personal Site',
  titleTemplate: 'Peter Kuria | %s',
